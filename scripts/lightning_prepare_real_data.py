...
DEFAULT_SOURCE_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "usage": "instruction",
        "trust_tier": "owned",
        "source_url": "local://configs/data/lafla-model-identity-380m.jsonl",
        "target_share": 0.07,
        "pii_cleaned": True,
    },
)
...
def main() -> int:
    ...
    parser.add_argument("--identity-jsonl", default="configs/data/lafla-model-identity-380m.jsonl")
...
def write_manifest(
    ...
    for spec in specs:
        ...
        source = {
            ...
            "notes": "generated_by=scripts/lightning_prepare_real_data.py; dedup=sha256-normalized-text; fake_data=false",
        }
    ...
    manifest = {
        ...
        "evaluationSets": [
            ...
            },
            {
                ...
                "language": "tr",
                "usage": "evaluation",
                "sourceUrl": "local://configs/data/lafla-model-identity-380m.jsonl",
            },
        ],
        "filters": {
