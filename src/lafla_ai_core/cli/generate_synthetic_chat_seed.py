"""
@Dosya: cli/generate_synthetic_chat_seed.py
@Aciklama: Lafla 100M sentetik thinking/chat SFT seed dosyasini uretir.
"""
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Lafla 100M synthetic thinking chat seed generator")
    ...
    report = generate_synthetic_chat_seed(
